...
public class AppViewManager {
    ...
    public static final AppView PRIMARY_VIEW = view("Matrix multiplication", PrimaryPresenter.class, MaterialDesignIcon.HOME, SHOW_IN_DRAWER, HOME_VIEW, SKIP_VIEW_STACK);
    public static final AppView SECONDARY_VIEW = view("Calculator", SecondaryPresenter.class, MaterialDesignIcon.DASHBOARD, SHOW_IN_DRAWER);
    ...
    public static void registerViewsAndDrawer(MobileApplication app) {
        ...
        NavigationDrawer.Header header = new NavigationDrawer.Header("Gluon Mobile Calculator App",
                "by liel",
                new Avatar(21, new Image(MainApp.class.getResourceAsStream("/icon.png"))));
